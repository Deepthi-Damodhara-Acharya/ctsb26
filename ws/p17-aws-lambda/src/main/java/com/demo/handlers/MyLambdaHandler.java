...
//	handler: com.demo.handlers.MyLambdaHandler::handleRequest
	...
	List<Book> books = Arrays.asList(new Book("Superman", "Mark", 15), new Book("Hulk", "John", 24),
			new Book("Spiderman", "Miley", 10), new Book("Antman", "Emily", 29), new Book("Hanuman", "Tom", 14),
			new Book("Shaktiman", "Kim", 15), new Book("Ironman", "Carl", 19), new Book("Batman", "Mark", 21),
